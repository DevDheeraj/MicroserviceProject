...
assert_defined({per,encode_fragmented_sof,3}) -> ok;
...
assert_defined({uper,encode_fragmented_sof,3}) -> ok;
...
dependencies({jer,decode_jer_component_map,3}) ->
[{jer,decode_jer,2},{jer,decode_jer_component_map,3}];
...
dependencies({jer,encode_jer_component_map,3}) ->
[{jer,encode_jer,2},{jer,encode_jer_component_map,3}];
...
[{jer,jer_encode_bitstring,1},
 {jer,jer_get_all_bitposes,3},
 {jer,jer_make_and_set_list,3}];
dependencies({jer,jer_encode_bitstring,1}) ->
[{jer,jer_encode_bitstring,2},{jer,jer_unused_bitlist,2}];
dependencies({jer,jer_encode_bitstring,2}) ->
[{jer,jer_unused_bitlist,2}];
...
[{per,align,1}];
dependencies({per,encode_fragmented_sof,3}) ->
[{per,encode_fragmented_sof_1,4}];
dependencies({per,encode_fragmented_sof_1,4}) ->
[{per,encode_components,4},{per,encode_fragmented_sof_1,4}];
...
dependencies({uper,encode_fragmented_sof,3}) ->
[{uper,encode_fragmented_sof_1,4}];
dependencies({uper,encode_fragmented_sof_1,4}) ->
[{uper,encode_components,4},{uper,encode_fragmented_sof_1,4}];
...
[{{ber,ber_encode,1},
 ...
 {{uper,encode_fragmented_sof,3},
  <<"\nencode_fragmented_sof(Fun, Comps, Len) ->\n    encode_fragmented_sof_1(Fun, Comps, Len, 4).\n">>},
 {{uper,encode_fragmented_sof_1,4},
  <<"\nencode_fragmented_sof_1(Encoder, Comps0, Len0, N) ->\n    SegSz = N * 16384,\n    if\n        Len0 >= SegSz ->\n            {Comps, B} = encode_components(Comps0, Encoder, SegSz, []),\n            Len = Len0 - SegSz,\n            [<<3:2,N:6>>,\n             B |\n             encode_fragmented_sof_1(Encoder, Comps, Len, N)];\n        N > 1 ->\n            encode_fragmented_sof_1(Encoder, Comps0, Len0, N - 1);\n        Len0 < 128 ->\n            {[], B} = encode_components(Comps0, Encoder, Len0, []),\n            [Len0 | B];\n        Len0 < 16384 ->\n            {[], B} = encode_components(Comps0, Encoder, Len0, []),\n            [<<2:2,Len0:14>> | B]\n    end.\n">>},
 {{uper,encode_components,4},
  <<"\nencode_components(Cs, _Encoder, 0, Acc) ->\n    {Cs, lists:reverse(Acc)};\nencode_components([C | Cs], Encoder, Size, Acc) ->\n    B = Encoder(C),\n    encode_components(Cs, Encoder, Size - 1, [B | Acc]).\n">>}].
