%% Generated by the Erlang ASN.1 BER compiler. Version: 5.3.3
...
-asn1_info([{vsn,'5.3.3'},
 ...
 {cwd,"/daily_build/otp_src/lib/megaco/src/binary"},
 {outdir,"/daily_build/otp_src/lib/megaco/src/binary"},
 noobj,legacy_erlang_types,asn1config,
 {i,"."},
 {i,"/daily_build/otp_src/lib/megaco/src/binary"}]}]).
...
%% 'actionReplies'
    {131073, V1} -> 
        {actionReplies, {'TransactionReply_transactionResult_actionReplies_parts',match_tags(V1, [])}};
...
%%-------------------------------------------------
[V2|Tlv3] = Tlv2, 
Term2 = {'TransactionRequest_actions_parts',match_tags(V2, [131073])},
...
%% 'transactions'
    {131073, V1} -> 
        {transactions, {'Message_messageBody_transactions_parts',match_tags(V1, [])}};
...
decode_message_version(Bytes) ->
  decode_partial_incomplete('MegacoMessage_1', Bytes, [mandatory,{opt_undecoded,[131072]},{mandatory,[mandatory,{undecoded,[131073]},{undecoded,[131074]}]}]).
decode_message_mId(Bytes) ->
  decode_partial_incomplete('MegacoMessage_2', Bytes, [mandatory,{opt_undecoded,[131072]},{mandatory,[mandatory,mandatory,{undecoded,[131074]}]}]).
decode_inc_disp('Message_messageBody_transactions_parts',Data) ->
  case Data of
    L when is_list(L) ->
...
decode_inc_disp('TransactionRequest_actions_parts',Data) ->
  case Data of
    L when is_list(L) ->
...
decode_inc_disp('TransactionReply_transactionResult_actionReplies_parts',Data) ->
  case Data of
    L when is_list(L) ->
...
decode_inc_disp('MegacoMessage_authHeader',Data) ->
  'dec_AuthenticationHeader'(Data,[131072]).
